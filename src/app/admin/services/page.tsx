        ...
        <main className="flex-1 pt-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
              <div>
                <h1 className="text-4xl font-bold text-[#0a192f] tracking-tight">
                  Service Management
                </h1>
            ...
            <Card className="mt-8 bg-[#0a192f] border-[#1e3a5f]">
              <div className="p-6">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Currently, services are managed using local data
                  (src/data/services.ts). This page is structured to easily
                  migrate to Supabase database management. To enable full
                  database integration, create a services table in Supabase and
                  update this component to use the Supabase client for CRUD
                  operations.
                </p>
              </div>
            </Card>
