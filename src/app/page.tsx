      ...
      <main className="flex-1 pt-20">
        ...
        <Section>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8 rounded-2xl bg-white border border-gray-200 hover:shadow-premium-lg transition-all duration-300 hover-lift">
              <div className="w-20 h-20 bg-gradient-to-br from-[#00d4ff] to-[#00b8e6] rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-[#00d4ff]/20">
              ...
              <p className="text-gray-600 leading-relaxed">Build systems tailored to your specific industrial requirements with precision engineering.</p>
            </div>
            <div className="text-center p-8 rounded-2xl bg-white border border-gray-200 hover:shadow-premium-lg transition-all duration-300 hover-lift">
              <div className="w-20 h-20 bg-gradient-to-br from-[#00d4ff] to-[#00b8e6] rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-[#00d4ff]/20">
                <svg className="w-10 h-10 text-[#0a192f]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-gray-600 leading-relaxed">Integration with leading industrial hardware brands for seamless compatibility.</p>
            </div>
            <div className="text-center p-8 rounded-2xl bg-white border border-gray-200 hover:shadow-premium-lg transition-all duration-300 hover-lift">
              <div className="w-20 h-20 bg-gradient-to-br from-[#00d4ff] to-[#00b8e6] rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg shadow-[#00d4ff]/20">
                <svg className="w-10 h-10 text-[#0a192f]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
